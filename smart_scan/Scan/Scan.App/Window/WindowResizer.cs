...
namespace Scan.App
{
    ...
    public class WindowResizer
    {
        ...
        static extern bool GetCursorPos(out Points lpPoint);

        [DllImport("user32.dll")]
        static extern bool GetMonitorInfo(IntPtr hMonitor, Monitorinfo lpmi);

        [DllImport("user32.dll", SetLastError = true)]
        static extern IntPtr MonitorFromPoint(Points pt, MonitorOptions dwFlags);
...
#pragma warning restore S1172 // Unused method parameters should be removed
        {
            ...
            Points lMousePosition;
            GetCursorPos(out lMousePosition);

            // Get the primary monitor at cursor position 0,0
            var lPrimaryScreen = MonitorFromPoint(new Points(0, 0), MonitorOptions.MONITOR_DEFAULTTOPRIMARY);
    ...
    {
        public Points ptReserved;
        public Points ptMaxSize;
        public Points ptMaxPosition;
        public Points ptMinTrackSize;
        public Points ptMaxTrackSize;
    };
